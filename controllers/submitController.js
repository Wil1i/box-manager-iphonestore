...
const post = async (req, res) => {
    ...
    sms.send(config.smsCodes.adminSMS, config.adminNumber, [req.body.phoneModel, req.body.capacity, req.body.color, req.body.partNumber, req.body.IMEI1, req.body.IMEI2])
